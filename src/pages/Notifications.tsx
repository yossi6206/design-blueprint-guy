              ...
              <div className="text-right space-y-2 md:space-y-4">
                ...
                <div className="flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-lg bg-accent/30 hover:bg-accent/50 transition-colors">
                  ...
                  <div className="text-right flex-1">
                    <span className="text-sm md:text-base font-semibold text-foreground block mb-1">לייקים</span>
                ...
                <div className="flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-lg bg-accent/30 hover:bg-accent/50 transition-colors">
                  ...
                  <div className="text-right flex-1">
                    <span className="text-sm md:text-base font-semibold text-foreground block mb-1">תגובות</span>
                ...
                <div className="flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-lg bg-accent/30 hover:bg-accent/50 transition-colors">
                  ...
                  <div className="text-right flex-1">
                    <span className="text-sm md:text-base font-semibold text-foreground block mb-1">עוקבים חדשים</span>
                ...
                <div className="flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-lg bg-accent/30 hover:bg-accent/50 transition-colors">
                  ...
                  <div className="text-right flex-1">
                    <span className="text-sm md:text-base font-semibold text-foreground block mb-1">ריטוויטים</span>
                ...
                <div className="flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-lg bg-accent/30 hover:bg-accent/50 transition-colors">
                  ...
                  <div className="text-right flex-1">
                    <span className="text-sm md:text-base font-semibold text-foreground block mb-1">תיוגים</span>
                ...
                <div className="flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-lg bg-accent/30 hover:bg-accent/50 transition-colors">
                  ...
                  <div className="text-right flex-1">
                    <span className="text-sm md:text-base font-semibold text-foreground block mb-1">קידומים</span>
                ...
                <div className="flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded-lg bg-accent/30 hover:bg-accent/50 transition-colors">
                  ...
                  <div className="text-right flex-1">
                    <span className="text-sm md:text-base font-semibold text-foreground block mb-1">אימותים</span>

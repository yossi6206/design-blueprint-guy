  ...
  return (
    <div className="min-h-screen bg-background flex relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 -left-4 w-96 h-96 bg-gradient-secondary opacity-5 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-0 -right-4 w-96 h-96 bg-gradient-accent opacity-5 rounded-full blur-3xl animate-float" style={{ animationDelay: "3s" }} />
      </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-muted/20 p-8 items-center justify-center overflow-hidden relative">
        <div className="absolute inset-0 bg-gradient-accent opacity-3" />
        <div className="w-full max-w-xl space-y-4 relative z-10">
          {samplePosts.map((post, index) => (
            <Card 
              key={post.id} 
              className="p-6 bg-card/90 backdrop-blur-sm hover:bg-accent/30 transition-all duration-200 border border-border/50"
            >

...
-- Views don't need SECURITY DEFINER as they don't execute functions

-- Recreate post_engagement_view without security definer
...
-- Recreate trending_hashtags_view without security definer
DROP VIEW IF EXISTS public.trending_hashtags_view;
CREATE VIEW public.trending_hashtags_view AS
SELECT 
  h.id,
  h.tag,

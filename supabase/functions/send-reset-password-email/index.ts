        ...
        <table class="container" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%;">
          ...
          <tr>
            <td style="padding-top: 32px; text-align: center;">
              ...
              <div style="margin: 24px 0; padding: 16px 0; border-top: 1px solid rgba(255, 255, 255, 0.05); border-bottom: 1px solid rgba(255, 255, 255, 0.05);">
                <a href="https://98fc86e2-8fcc-4ef8-be9e-f1890194852f.lovableproject.com" style="color: #667eea; font-size: 13px; text-decoration: none; margin: 0 12px; font-weight: 500;">🏠 אתר הבית</a>
                <span style="color: #404040;">•</span>
                <a href="https://98fc86e2-8fcc-4ef8-be9e-f1890194852f.lovableproject.com" style="color: #667eea; font-size: 13px; text-decoration: none; margin: 0 12px; font-weight: 500;">💬 תמיכה</a>
              </div>
